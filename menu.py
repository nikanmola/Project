...
def callback_query(call):
    if call.data == 'menu1':
        bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text="You are in menu1", reply_markup=submenu1())  #bot.edit_message_text(text="متن جدید", chat_id=call.message.chat.id, message_id=call.message.message_id, reply_markup=new_markup)
